...
public class PassengerChanged extends DomainEvent {
    private final PassengerId passengerId;
    private final Name name;
    private final PhoneNumber phoneNumber;
    private final Email email;

    public PassengerChanged(PassengerId passengerId, Name name, PhoneNumber phoneNumber, Email email) {
        super("sofka.easy_fly.reservation.passengerchanged");
